...
class Parameters {
  ...
  Parameters addFilter(String filter) {
    _filters.add(("&filter" + filter).replaceAll(new RegExp(" "), ""));
    return this;
  }

  Parameters addIds(String ids) {
    _ids = ids.replaceAll(new RegExp(" "), "");
    return this;
  }

  Parameters addOffset(String offset) {
    _offset = "&offset=" + offset.replaceAll(new RegExp(" "), "");
    return this;
  }

  Parameters addFields(String fields) {
    _fields = fields.replaceAll(new RegExp(" "), "");
    return this;
  }

  Parameters addExpand(String expand) {
    _expand = "&expand=" + expand.replaceAll(new RegExp(" "), "");
    return this;
  }

  Parameters addLimit(String limit) {
    _limit = "&limit=" + limit.replaceAll(new RegExp(" "), "");
    return this;
  }

  Parameters addOrder(String order) {
    _order = "&order=" + order.replaceAll(new RegExp(" "), "");
    return this;
  }

  Parameters addSearch(String search) {
    _search = "?search=" + search.replaceAll(new RegExp(" "), "%20");
    return this;
  }

  Parameters addScroll(String scroll) {
    _scroll = "&scroll=" + scroll.replaceAll(new RegExp(" "), "");
    return this;
  }
